  ...
  <br>
      <div class="card"><br>
          ...
          <div class="row">
                  ...
                  <div align="left"><input type="text" name="deleteuser" required="" placeholder="EMPLOYEE ID">
              <button class="buttonsearch" type="submit" name="log">SEARCH</button></div>
              </form> </span>
  </div></div>
            <div style="overflow-x:auto;">
                    <?php  
                        if(isset($_POST['deleteuser']))   {
                            ...
                            WHERE EMPLOYEE_ID LIKE '%".$deleteuser."%' 
                            ORDER BY EMPLOYEE_ID";
                            $log = oci_parse($connection, $sql);
                            oci_execute($log);                   
                            if( $count = oci_num_rows($log))
                            { 
                            while($row = oci_fetch_array($log))
                            {
                            ?>
                            <?php echo $i++ ?>.
                            <table align="center"> 
                        ...
                        <button class="buttondelete"type="submit" name="delete" onClick="return confirmdelete()">DELETE</button>
                    </form>  
                            <?php
                        }}
                        else { ?>
      ...
      </div> <!--div margin-left:15%;padding:10px 16px --->
</div> <!--div tb -->
...
if (isset($_POST['submit'])) 
{
  ...
  $sql2="INSERT INTO EMPLOYEE(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, BIRTH_DATE, ADDRESS, CITY, STATE, POSTAL_CODE, COUNTRY, PHONE, HIRE_DATE, POSITION, SUPERVISOR_ID) VALUES  ('$empid','$fname','$lname','$birthdate','$address','$city','$state','$postalcode','$country','$phone','$hiredate','$position','$supervisorid')";
