...
<head>
    ...
    <style>
        ...
        html {
            ...
            color: #ff0000e7;
            /* Text Color for about us description */
            background: rgb(169, 209, 99);
                ...
                <div>
                    <form action="order.php" method="POST" name="tblform">
                        ...
                        <div class="notesbox">
                            ...
                            <textarea name="notes" id="notes" style="width:50%;height:90px;background-color:green;border:none;padding:2%;font:22px/30px sans-serif;"></textarea>
                        </div text>
                        <br>
