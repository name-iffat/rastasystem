        ...
        <container>
            <div>
                <form action="order.php" method="POST" name="tblform" >
                    ...
                    <td><input readonly value="0" id="p1" /></td>
                    </tr>   
                    <tr>
                    ...
                    <td><input readonly value="0"  id="p2"></td>  
                    </tr> 
                    <tr>
                    ...
                    <td><input readonly value="0"" id="p3"></td> 
                    </tr> 
                    <tr>
                    ...
                    <td><input readonly value="0"  id="p4"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p5"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0" id="p6"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p7"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p8"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p9"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p10"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p11"></td> 
                    </tr>
                    <tr>
                        ...
                        <td><input readonly value="0"  id="p12"></td> 
                    </tr>
                    <tr>
                    <td></td> 
                    <td>Total</td>
