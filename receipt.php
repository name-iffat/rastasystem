        ...
        <td class="container" width="600">
            <div class="content">
                <table class="main" width="100%" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                        <td class="content-wrap align-items-center">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block text-center">
                                        <a href="statUNPAID.php?payment_id=<?php echo $payid; ?>"><button class="button mb-2">Pay later</button></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block text-center">
                                    <a href="statPAID.php?payment_id=<?php echo $payid; ?>"><button class="button mb-2">Pay Now</button></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block text-center">
